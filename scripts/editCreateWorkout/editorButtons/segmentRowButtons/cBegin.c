editCreateWorkout: editorButtons: segmentRowButtons: cBegin
...
If [ activity::rowBend = "" ]
Go to Field [ ]
Show Custom Dialog [ Message: "Set the end segment for the second row before setting the beginning segment for this third
row."; Buttons: “OK” ]
Exit Script [ ]
End If
#
...
If [ $segment > GetValue ( activity::rowBend ; 1 ) ]
Go to Field [ ]
...
#
#Set new row ending.
Go to Object [ Object Name: "cBegin" & $segment ]
Set Field [ $segment & ¶ ]
Set Variable [ $$stop ]
