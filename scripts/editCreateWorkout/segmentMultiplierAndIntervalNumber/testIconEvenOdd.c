...
Set Field [ "" ]
Show Custom Dialog [ Message: "This icon requires an " & $evenOdd & " number to finish up with a heart rate that will end up
where the icons line ends up."; Buttons: “OK” ]
Exit Script [ ]
End If
Go to Field [ ]
January 8, 平成26 15:48:15 Fat and Muscle Efficiency Research.fp7 - testIconEvenOdd -1-
